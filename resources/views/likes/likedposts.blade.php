...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Lajkovane objave:') }}</div>
                    <div class="card-body">
                        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/remixicon/4.2.0/remixicon.min.css">
                        <link rel="stylesheet" href="{{ asset('css/style.css') }}">
                        @if($posts->isEmpty())
                            <h4 class="no-post"><i>NEMA LAJKOVANIH OBJAVA</i></h4>
                            @endif
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="/post/{{$post->id}}">
                                <h4 class="card-title" id="post-title"> <b> {{ $post->title }}</b> @if($post->edited == "yes") (edited)@endif</a>
